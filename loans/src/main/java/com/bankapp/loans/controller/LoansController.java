...
import com.bankapp.loans.dto.ErrorResponseDto;
import com.bankapp.loans.dto.LoansDto;
import com.bankapp.loans.dto.ResponseDto;
...
@Tag(
        ...
        description = "CRUD REST APIs in BankApp to CREATE, UPDATE, FETCH, and DELETE loans details."
)
@RestController
...
public class LoansController {
    ...
    public ResponseEntity<ResponseDto> deleteLoanDetails(@RequestParam
                                                         @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                         String mobileNumber){
        boolean isDeleted = iLoansService.deletedLoan(mobileNumber);
